                                ...
                                <Row>
                                    <Col md={6} lg={2} className={(this.state.addBtnClicked && !this.state.date) ? 'has-error' : ''}>
                                        ...
                                        <FormControl type="date" onChange={this.onChangeDate}
                                                     defaultValue={(this.props.editedPost) ? this.props.editedPost.post_date_start.substr(0, 10) : null}/>
                                    </Col>
                                    <Col md={6} lg={4}>
                                        <Row>
                                            <Col xs={12} sm={6}
                                ...
                                <Row>
                                    <Col md={12} lg={12}
                                        ...
                                        <textarea className="form-control" onChange={this.onChangeDescription}
                                                  defaultValue={(this.props.editedPost) ? this.props.editedPost.post_description : ''}></textarea>
                                    </Col>
                                </Row>
                            </FormGroup>
